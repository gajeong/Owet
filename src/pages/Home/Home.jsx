...
export default function Home() {
  return (
    <>
      <main className='flex items-center max-sm:flex-col'>
        <div
          className={`${styles.myungjo} w-5/12 p-4 max-sm:w-full max-sm:text-base max-sm:my-8`}
        >
          ...
          <p className='text-xl font-bold text-brown4 transition  animate__animated animate__slideInDown'>
            나를 위한 풍부하고{' '}
            <span className='text-brown5'>편안한 시간</span>
            을 선사한다.
          </p>
        </div>
        <img
